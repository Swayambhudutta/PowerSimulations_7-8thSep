...
st.markdown("Simulate IEX prices for a selected year using Monte Carlo simulations with adjustable parameters.")

# Dropdown to select prediction year
selected_year = st.selectbox("Select Prediction Year", list(range(2026, 2051)))

# Sidebar inputs
st.sidebar.header("Traditional Sources")
...
st.sidebar.header("External Shocks")
external_shock = st.sidebar.slider("External Shock Factor (%)", -20, 20, 0)

st.sidebar.header("Confidence Interval")
